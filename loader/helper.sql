...
SELECT md5, CONCAT(lat, ",", lng), title, description, href, picture, CONCAT(region, ", ", country), free, modified INTO OUTFILE '/tmp/attractions.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' FROM place;
